 ...
 const {mode} = useContext(AppContext);
  ...
  return (
    <div id='Projects' className=''>
        ...
        <p className={`mt-4 w-1/2  text-center mx-auto ${mode=='light' ? 'text-richblack-800' : 'text-richblack-50'}`}>Acquired one and a half years of experience building and learning new web skills, applying them to create various projects. Feel free to explore and share your thoughts</p>
        </div>
        <div className='w-full md:w-10/12 mx-auto flex flex-col relative gap-y-14 mt-10 py-6 '>
          {
            projectDetails.map((currProject,index) => (
                <div className={`w-9/12 h-[400px]  hover:scale-110 transition-all duration-200 group hover:bg-black hover:z-50 relative  shadow-xl  rounded-2xl  self-center ${!index%2 ? 'md:self-start':'md:self-end'} shadow-black `}>
                    <div className='w-full flex rounded-2xl  '>
                        ...
                        src={currProject.projectImg}></img></div>
                           ...
                           transition-all duration-200 justify-center  gap-y-5  z-[20]`}>
