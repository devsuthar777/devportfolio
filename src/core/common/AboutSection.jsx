  ...
  return (
    ...
    justify-between items-center py-5`}>
        <div className='flex flex-col w-[80%] md:w-[60%] items-center mx-16 gap-2 mt-5 '>
            ...
            <span className='text-5xl py-2 items-center w-[100%]  flex md:text-left flex-col md:flex-row  gap-2 h-[180px] md:h-auto '><span className='text-5xl text-center '>I am</span>{"  "}
            <span className={`text-center flex items-center ${mode=='dark' ? 'text-blue-300' : 'text-richblack-50'}  `}>
    ...
    />
            ...
            <p className={`text-center md:text-left ${mode=='light' ? 'text-richblack-800' : 'text-richblack-50'} `}>Very enthusisatic, coding as a hobby now putting my steps into world of web Development. Look at the work done by me and share your views.</p>
            <p className='text-center md:text-left'>Looking for MERN Full-Stack Developer Job</p>
